...
function createModelModule() {
    ...
    _.extend(ImageCollectionModel.prototype, {
        ...
        addImageModel: function(imageModel) {
            ...
            var boolean = _.find(this.imageModels, function(existingModel){
               if(existingModel.path == imageModel.path){
                   return true;
               }
            });

            if(boolean != undefined){
                window.alert("You already have this picture loaded.");
                return;
            }
            ...
            imageModel.addListener(this.imagePropertyChange.bind(this));
        },
        ...
        imagePropertyChange: function(imageModel, eventTime){
            _.each(this.listeners, function(listener){
